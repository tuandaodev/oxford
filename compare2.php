...
<html lang="en">
  ...
  <?php
    ...
    $file_input = 'input/compare_input2.txt';
    $file_list_input = 'input/compare_list_input2.txt';
    
    $file_exported = 'export/compare_exported2.xlsx';
    $need_export = false;
...
function utf8_str_word_count($string, $format = 0, $charlist = null)
{
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="compare2.php">Compare 2</a></li>

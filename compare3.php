...
<html lang="en">
  ...
  <?php
    ...
    $file_input = 'input/compare_input3.txt';
    $file_list_input = 'input/compare_list_input3.txt';
    
    $file_exported = 'export/compare_exported3.xlsx';
    $need_export = false;
...
function utf8_str_word_count($string, $format = 0, $charlist = null)
{
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="compare3.php">Compare 3</a></li>
